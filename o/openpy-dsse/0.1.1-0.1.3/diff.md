# Comparing `tmp/openpy_dsse-0.1.1.tar.gz` & `tmp/openpy_dsse-0.1.3.tar.gz`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/base_DSSE.py` & `openpy_dsse-0.1.3/openpy_dsse/base_DSSE.py`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/MEAS_files/Init_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/MEAS_files/Init_Elem_ft.json`
 ...
 * *Differences: {"'0'": "{'Unc(%)_PQft': 0, 'STS_PQft': 0}",*

 * * "'12'": "{'Unc(%)_PQft': 0, 'Unc(%)_Ift': 0}",*

 * * "'4'": "{'Unc(%)_PQft': 0, 'STS_PQft': 0}"}*
...
+        "Unc(%)_PQft": 0,
         ...
         "bus2": "bus_14.1",
         "conn": "",
         "element_name": "Line.from_4_to_14",
         "from_bus": "bus_4",
         "num_cond": 1,
         "num_ph": 1,
@@ -133,17 +133,17 @@
...
+        "Unc(%)_PQft": 0,
         ...
         "bus2": "bus_9.1",
         "conn": "",
         "element_name": "Line.from_2_to_9",
         "from_bus": "bus_2",
         "num_cond": 1,
         "num_ph": 1,
```

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/MEAS_files/Init_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/MEAS_files/Init_Elem_ft_PMU.json`

 * *Files 4% similar despite different names*

#### Pretty-printed

 * *Similarity: 0.9945054945054945%*

 * *Differences: {"'2'": "{'Unc(%)_Ift': 0, 'STS_Ift': 0}", "'5'": "{'Unc(%)_Ift': 0, 'STS_Ift': 0}"}*
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/MEAS_files/MEAS_Bus_i_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/MEAS_files/MEAS_Elem_ft_PMU.json`

 * *Files 18% similar despite different names*

#### Pretty-printed

 * *Similarity: 0.5886363636363637%*

 * *Differences: {"'0'": "{'Ang1m(deg)': 0, 'element_name': 'Line.from_1_to_2', 'num_ph': 1, 'from_bus': 'bus_1', "*

 * *        "'to_bus': 'bus_2', 'STS_Ift': 0, 'Rii_Ift': 0, 'I1mft(pu)': 0, 'I2mft(pu)': 0, "*

 * *        "'I3mft(pu)': 0, delete: ['bus_name', 'num_nodes', 'STS_Vm', 'Rii_Vm', 'V1m(pu)', "*

 * *        "'V2m(pu)', 'V3m(pu)']}",*

 * * "'1'": "{'element_name': 'Line.from_2_to_3', 'num_ph': 1, 'from_bus': 'bus_2', 'to_bus': 'bus_3', "*

 * *        "'STS_Ift': 0, 'Rii_Ift': 0, 'I1mft(pu)': 0, 'I2mft(pu)': 0, 'I3mft(pu)': 0, delete: "*
...
+        "Rii_Ift": 0,
+        "STS_Ift": 0,
+        "element_name": "Line.from_11_to_12",
+        "from_bus": "bus_11",
+        "num_ph": 1,
         "ph_1": 1,
         "ph_2": 0,
...
+        "Rii_Ift": 0,
+        "STS_Ift": 0,
+        "element_name": "Line.from_12_to_13",
+        "from_bus": "bus_12",
+        "num_ph": 1,
         "ph_1": 1,
         "ph_2": 0,
...
+        "Rii_Ift": 0,
+        "STS_Ift": 0,
+        "element_name": "Line.from_4_to_15",
+        "from_bus": "bus_4",
+        "num_ph": 1,
         "ph_1": 1,
         "ph_2": 0,
...
+        "Rii_Ift": 0,
+        "STS_Ift": 0,
+        "element_name": "Line.from_3_to_11",
+        "from_bus": "bus_3",
+        "num_ph": 1,
         "ph_1": 1,
         "ph_2": 0,
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/MEAS_files/MEAS_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/MEAS_files/MEAS_Elem_ft.json`
 ...
 * *Differences: {"'0'": "{'STS_PQft': 0, 'Rii_PQft': 0, 'P1mft(pu)': 0, 'P2mft(pu)': 0, 'P3mft(pu)': 0, "*

 * *        "'Q1mft(pu)': 0, 'Q2mft(pu)': 0, 'Q3mft(pu)': 0}",*

 * * "'4'": "{'STS_PQft': 0, 'Rii_PQft': 0, 'P1mft(pu)': 0, 'P2mft(pu)': 0, 'P3mft(pu)': 0, "*
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/MEAS_files/MEAS_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Bus_i_PMU.json`

 * *Files 24% similar despite different names*

#### Pretty-printed

 * *Similarity: 0.2039473684210526%*

 * *Differences: {"'0'": "{'bus_name': '799', 'STS_Vm': 0, 'Rii_Vm': 0.0, 'V1m(pu)': 0.0, delete: ['element_name', "*

 * *        "'num_ph', 'from_bus', 'to_bus', 'ph_1', 'ph_2', 'ph_3', 'STS_Ift', 'Rii_Ift', "*

 * *        "'I1mft(pu)', 'I2mft(pu)', 'I3mft(pu)', 'Ang2m(deg)', 'Ang3m(deg)']}",*

 * * "'1'": "{'bus_name': '701', 'STS_Vm': 0, 'Rii_Vm': 0.0, 'V1m(pu)': 0.0, delete: ['element_name', "*

 * *        "'num_ph', 'from_bus', 'to_bus', 'ph_1', 'ph_2', 'ph_3', 'STS_Ift', 'Rii_Ift', "*

 * *        "'I1mft(pu)', 'I2mft(pu)', 'I3mft(pu)', 'Ang2m( […]*
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/OpenDSS files/Line_15node.dss` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/OpenDSS files/Line_15node.dss`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/OpenDSS files/Load_15node.dss` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/OpenDSS files/Load_15node.dss`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/15NodeIEEE/Results/Results_DSSE_15NodeIEEE.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/15NodeIEEE/Results/Results_DSSE_15NodeIEEE.json`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Bus_i.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Bus_i.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Bus_i_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Bus_i_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Elem_ft.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Init_Elem_ft_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Bus_i.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Bus_i.json`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Bus_i_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Bus_i_PMU.json`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Elem_ft.json`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/MEAS_Elem_ft_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Bus_i.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Bus_i.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Elem_ft.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/MEAS_files/Pos_MEAS_Elem_ft_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/AddMarks.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/AddMarks.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/IEEE37_BusXY.csv` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/IEEE37_BusXY.csv`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Isolated.Txt` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Isolated.Txt`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Power.dbl` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Power.dbl`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Power.DSV` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/ieee37_Power.DSV`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/IEEELineCodes.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/IEEELineCodes.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Lines.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Lines.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Loads.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Loads.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/BusCoords.dss` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/BusCoords.dss`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Line.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Line.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/LineCode.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/LineCode.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Load.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Load.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Spectrum.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/Spectrum.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/TCC_Curve.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/PosSeq circuit/TCC_Curve.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Regulator.DSS` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/OpenDSS files/Regulator.DSS`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/37NodeIEEE/Results/Results_DSSE_37nodeIEEE.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/37NodeIEEE/Results/Results_DSSE_37nodeIEEE.json`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/Init_Bus_i.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/Init_Bus_i.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/Init_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/Init_Elem_ft.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/Init_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/Init_Elem_ft_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/MEAS_Bus_i.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/MEAS_Bus_i.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/MEAS_Bus_i_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/MEAS_Bus_i_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/MEAS_Elem_ft.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/MEAS_Elem_ft.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/MEAS_files/MEAS_Elem_ft_PMU.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/MEAS_files/MEAS_Elem_ft_PMU.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/examples/4Node/Results/Results_DSSE_4Node.json` & `openpy_dsse-0.1.3/openpy_dsse/examples/4Node/Results/Results_DSSE_4Node.json`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/LICENSE.md` & `openpy_dsse-0.1.3/openpy_dsse/LICENSE.md`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/MEAS_from_OpenDSS.py` & `openpy_dsse-0.1.3/openpy_dsse/MEAS_from_OpenDSS.py`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/OpenDSS_data_extraction.py` & `openpy_dsse-0.1.3/openpy_dsse/OpenDSS_data_extraction.py`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/Readme.md` & `openpy_dsse-0.1.3/openpy_dsse/Readme.md`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/Sample_test_systems_DSS.py` & `openpy_dsse-0.1.3/openpy_dsse/Sample_test_systems_DSS.py`

 * *Files identical despite different names*

### Comparing `openpy_dsse-0.1.1/openpy_dsse/state_estimation.py` & `openpy_dsse-0.1.3/openpy_dsse/state_estimation.py`
...
### Comparing `openpy_dsse-0.1.1/openpy_dsse/YBus_Matrix_Pos_Seq.py` & `openpy_dsse-0.1.3/openpy_dsse/YBus_Matrix_Pos_Seq.py`
...
### Comparing `openpy_dsse-0.1.1/pyproject.toml` & `openpy_dsse-0.1.3/pyproject.toml`
...
### Comparing `openpy_dsse-0.1.1/README.md` & `openpy_dsse-0.1.3/README.md`
...
### Comparing `openpy_dsse-0.1.1/setup.py` & `openpy_dsse-0.1.3/setup.py`
...
### Comparing `openpy_dsse-0.1.1/PKG-INFO` & `openpy_dsse-0.1.3/PKG-INFO`
