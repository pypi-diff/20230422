

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineage/utils/helpers.py` & `sqllineage-1.4.2/sqllineage/utils/helpers.py`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineage.egg-info/PKG-INFO` & `sqllineage-1.4.2/sqllineage.egg-info/PKG-INFO`
...
### Comparing `sqllineage-1.4.1/sqllineage.egg-info/SOURCES.txt` & `sqllineage-1.4.2/sqllineage.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/package-lock.json` & `sqllineage-1.4.2/sqllineagejs/package-lock.json`
 ...
 * *Differences: {"'packages'": "{'': {'version': '1.4.2'}}", "'version'": "'1.4.2'"}*
...
### Comparing `sqllineage-1.4.1/sqllineagejs/package.json` & `sqllineage-1.4.2/sqllineagejs/package.json`
...
### Comparing `sqllineage-1.4.1/sqllineagejs/public/favicon.ico` & `sqllineage-1.4.2/sqllineagejs/public/favicon.ico`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/public/index.html` & `sqllineage-1.4.2/sqllineagejs/public/index.html`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/public/logo192.png` & `sqllineage-1.4.2/sqllineagejs/public/logo192.png`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/public/logo512.png` & `sqllineage-1.4.2/sqllineagejs/public/logo512.png`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/App.js` & `sqllineage-1.4.2/sqllineagejs/src/App.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/api/client.js` & `sqllineage-1.4.2/sqllineagejs/src/api/client.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/directory/Directory.js` & `sqllineage-1.4.2/sqllineagejs/src/features/directory/Directory.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/directory/DirectoryTreeItem.js` & `sqllineage-1.4.2/sqllineagejs/src/features/directory/DirectoryTreeItem.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/directory/directorySlice.js` & `sqllineage-1.4.2/sqllineagejs/src/features/directory/directorySlice.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/editor/DAG.js` & `sqllineage-1.4.2/sqllineagejs/src/features/editor/DAG.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/editor/DAGDesc.js` & `sqllineage-1.4.2/sqllineagejs/src/features/editor/DAGDesc.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/editor/Editor.js` & `sqllineage-1.4.2/sqllineagejs/src/features/editor/Editor.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/editor/editorSlice.js` & `sqllineage-1.4.2/sqllineagejs/src/features/editor/editorSlice.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/widget/LoadError.js` & `sqllineage-1.4.2/sqllineagejs/src/features/widget/LoadError.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/features/widget/Loading.js` & `sqllineage-1.4.2/sqllineagejs/src/features/widget/Loading.js`

 * *Files identical despite different names*

### Comparing `sqllineage-1.4.1/sqllineagejs/src/index.css` & `sqllineage-1.4.2/sqllineagejs/src/index.css`
