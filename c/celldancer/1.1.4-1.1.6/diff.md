# Comparing `tmp/celldancer-1.1.4.tar.gz` & `tmp/celldancer-1.1.6.tar.gz`
...
## Comparing `celldancer-1.1.4.tar` & `celldancer-1.1.6.tar`
...
### Comparing `celldancer-1.1.4/LICENSE` & `celldancer-1.1.6/LICENSE`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/PKG-INFO` & `celldancer-1.1.6/PKG-INFO`
...
### Comparing `celldancer-1.1.4/readme.rst` & `celldancer-1.1.6/readme.rst`
...
### Comparing `celldancer-1.1.4/setup.py` & `celldancer-1.1.6/setup.py`
...
### Comparing `celldancer-1.1.4/src/celldancer/__init__.py` & `celldancer-1.1.6/src/celldancer/__init__.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/compute_cell_velocity.py` & `celldancer-1.1.6/src/celldancer/compute_cell_velocity.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/diffusion.py` & `celldancer-1.1.6/src/celldancer/diffusion.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/embedding_kinetic_para.py` & `celldancer-1.1.6/src/celldancer/embedding_kinetic_para.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/model/branch.pt` & `celldancer-1.1.6/src/celldancer/model/branch.pt`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/model/circle.pt` & `celldancer-1.1.6/src/celldancer/model/circle.pt`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/plotting/cell.py` & `celldancer-1.1.6/src/celldancer/plotting/cell.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/plotting/colormap.py` & `celldancer-1.1.6/src/celldancer/plotting/colormap.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/plotting/gene.py` & `celldancer-1.1.6/src/celldancer/plotting/gene.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/plotting/graph.py` & `celldancer-1.1.6/src/celldancer/plotting/graph.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/pseudo_time.py` & `celldancer-1.1.6/src/celldancer/pseudo_time.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/sampling.py` & `celldancer-1.1.6/src/celldancer/sampling.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/simulation.py` & `celldancer-1.1.6/src/celldancer/simulation.py`

 * *Files identical despite different names*

### Comparing `celldancer-1.1.4/src/celldancer/utilities.py` & `celldancer-1.1.6/src/celldancer/utilities.py`
...
### Comparing `celldancer-1.1.4/src/celldancer/velocity_estimation.py` & `celldancer-1.1.6/src/celldancer/velocity_estimation.py`
...
### Comparing `celldancer-1.1.4/src/celldancer.egg-info/PKG-INFO` & `celldancer-1.1.6/src/celldancer.egg-info/PKG-INFO`
