# Comparing `tmp/gpt_gateway-0.0.4.tar.gz` & `tmp/gpt_gateway-0.0.5.tar.gz`
...
### Comparing `gpt_gateway-0.0.4/gpt_gateway/client.py` & `gpt_gateway-0.0.5/gpt_gateway/client.py`
