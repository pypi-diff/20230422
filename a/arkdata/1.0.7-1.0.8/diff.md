# Comparing `tmp/arkdata-1.0.7.tar.gz` & `tmp/arkdata-1.0.8.tar.gz`
...
### Comparing `arkdata-1.0.7/src/arkdata/database/configuration.py` & `arkdata-1.0.8/src/arkdata/database/configuration.py`
