# Comparing `tmp/ats_base-1.1.3.tar.gz` & `tmp/ats_base-1.1.4.tar.gz`
...
## Comparing `ats_base-1.1.3.tar` & `ats_base-1.1.4.tar`
...
### Comparing `ats_base-1.1.3/PKG-INFO` & `ats_base-1.1.4/PKG-INFO`
...
### Comparing `ats_base-1.1.3/README.md` & `ats_base-1.1.4/README.md`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/base/entrance.py` & `ats_base-1.1.4/ats_base/base/entrance.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/base/req.py` & `ats_base-1.1.4/ats_base/base/req.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/common/func.py` & `ats_base-1.1.4/ats_base/common/func.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/common/resp.py` & `ats_base-1.1.4/ats_base/common/resp.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/config/rewrite_config.py` & `ats_base-1.1.4/ats_base/config/rewrite_config.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/log/logger.py` & `ats_base-1.1.4/ats_base/log/logger.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/service/db.py` & `ats_base-1.1.4/ats_base/service/db.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/service/mm.py` & `ats_base-1.1.4/ats_base/service/mm.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base/service/pro.py` & `ats_base-1.1.4/ats_base/service/pro.py`

 * *Files identical despite different names*

### Comparing `ats_base-1.1.3/ats_base.egg-info/PKG-INFO` & `ats_base-1.1.4/ats_base.egg-info/PKG-INFO`
...
### Comparing `ats_base-1.1.3/ats_base.egg-info/SOURCES.txt` & `ats_base-1.1.4/ats_base.egg-info/SOURCES.txt`
...
### Comparing `ats_base-1.1.3/setup.py` & `ats_base-1.1.4/setup.py`
