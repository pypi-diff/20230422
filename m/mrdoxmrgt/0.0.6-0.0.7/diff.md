# Comparing `tmp/mrdoxmrgt-0.0.6.tar.gz` & `tmp/mrdoxmrgt-0.0.7.tar.gz`
...
## Comparing `mrdoxmrgt-0.0.6.tar` & `mrdoxmrgt-0.0.7.tar`
...
### Comparing `mrdoxmrgt-0.0.6/LICENCE` & `mrdoxmrgt-0.0.7/LICENCE`

 * *Files identical despite different names*

### Comparing `mrdoxmrgt-0.0.6/PKG-INFO` & `mrdoxmrgt-0.0.7/PKG-INFO`
...
### Comparing `mrdoxmrgt-0.0.6/mrdoxmrgt/GTF/install.py` & `mrdoxmrgt-0.0.7/mrdoxmrgt/GTF/install.py`
...
-                if (re.search(reponame.lower(), repo.lower()) == None): pass
-                else: print(f"    {repo}")
+        if (len(reponame) == 0): print(f"[!] Program not found")
+        else:
+            print(f"[!] Program not found '{reponame}'")
+            if (DID): print(f"[+] Did you mean,\n")
+            for repo in Repository:
...
### Comparing `mrdoxmrgt-0.0.6/mrdoxmrgt/GTF/run.py` & `mrdoxmrgt-0.0.7/mrdoxmrgt/GTF/run.py`

 * *Files identical despite different names*

### Comparing `mrdoxmrgt-0.0.6/mrdoxmrgt/_main_.py` & `mrdoxmrgt-0.0.7/mrdoxmrgt/_main_.py`
...
### Comparing `mrdoxmrgt-0.0.6/mrdoxmrgt.egg-info/PKG-INFO` & `mrdoxmrgt-0.0.7/mrdoxmrgt.egg-info/PKG-INFO`
...
### Comparing `mrdoxmrgt-0.0.6/setup.py` & `mrdoxmrgt-0.0.7/setup.py`
